...
define('RESTPT', 'http://localhost:8283/services/PRDDataService/');
define('REST_TDS', 'http://localhost:8283/services/PRDDataService/');
define('REST2', 'http://localhost:8283/services/PRDDataService');
define('REST3', 'http://localhost:8283/services/PRDDataService');
define('REST4', 'http://localhost:8283/services/PRDDataService');
define('REST_PRD_LOTE', 'http://localhost:8283/services/PRDLoteDataService');
define('REST_CORE', 'http://localhost:8283/services/COREDataService/');
define('REST_PRD_ETAPA', 'http://localhost:8283/services/PRDEtapaDataService');

#TOOLS-PRD DATASERVICES /*NUEVOS*/
define('PRD_Etapa_DS', 'http://localhost:8283/services/PRDEtapaDataService/');
define('PRD_Lote_DS', 'http://localhost:8283/services/PRDLoteDataService/');
define('LOG_DS', 'http://localhost:8283/services/LOGDataService/');
define('CORE_DS','http://localhost:8283/services/COREDataService/');
...
define('REST_API_BPM', 'http://localhost:8283/tools/bpm/proceso/instancia');