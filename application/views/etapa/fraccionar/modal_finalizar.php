  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="row">
          ...
          <div class="col-xs-9" id="divloteorigen"></div>
      </div>
   ...
   <div class="col-xs-6 input-group">
     ...
     <div class="row" style="margin-top:20px">
      ...
      <div class="row" style="margin-top:20px">
          <div class="col-xs-3"></div>
          <div class="col-xs-3"><button class="btn btn-success btn-block" onclick="AgregarProductoFinal()">Agregar</button></div>
          <div class="col-xs-6"></div>
      </div>
      <div class="row">
      <input type="hidden" value="no" id="productos_existe">
             <div class="col-xs-12" id="productosasignadosfin">
             </div>
        </div>
      </div>
