...
if (accion == "Editar")
{
  ...
  function guardar()
  {
     ...
     $.ajax({
      type: 'POST',
      data: { idetapa:idetapa, lote:lote, fecha:fecha,establecimiento: establecimiento, recipiente:recipiente, op:op  },
...
$("#modal_finalizar").modal('show');
  ...
  $(document).off('click', '.tablamateriasasignadas_borrar').on('click', '.tablamateriasasignadas_borrar',{ idtabla:'tablamateriasasignadas', idrecipiente:'materiasasignadas', idbandera:'materiasexiste' }, remover);
