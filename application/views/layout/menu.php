<ul class="sidebar-menu menu tree" data-widget="tree">
    ...
    <li><a class="link" href="#" data-link="general/Camion/cargarCamion"><i class="fa fa-truck"></i>Cargar Camión</a>
    </li>
    ...
    <li><a class="link" href="#" data-link="general/Camion/cargadeCamion"><i class="fa fa-circle-o"></i>Listado Carga Camion</a>
    </li>
    <li><a class="link" href="#" data-link="general/Camion/recepcionCamion"><i class="fa fa-circle-o"></i>Listado Recepcion Camion</a>
    </li>
</ul>