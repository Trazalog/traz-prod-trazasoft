...
function ActualizaLote(lote)
 {
   ...
   } else  if(existe == 'si')
   {
      ...
      html +='</tr></thead><tbody>';
       ...
       for( i =0;i<result.length;i++)
       {
             ...
             html += '<td><i class="fa fa-fw fa-plus text-light-blue tabla_lotes_nuevo" style="cursor: pointer; margin-left: 15px;" title="Agregar"></i></td>';
      ...
      function FinalizarCarga()
  {
    ...
    if(existe == "no")
    {
      ...
      $(document).off('click', '.tabla_carga_borrar').on('click', '.tabla_carga_borrar',{ idtabla:'tabla_carga', idrecipiente:'tablacargas', idbandera:'existe_tabla' }, remover);
      </script>