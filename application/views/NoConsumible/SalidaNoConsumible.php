...
<h4 class="box-title">Vale de Salida</h4>
    ...
    <div class="box-body" id="div_vale_salida">
    <form action="">
    ...
    <label for="destino" class="col-md-1">Destino:</label>
    <div class="col-md-2">
    <input id="destino" name="destino" type="text" placeholder="Ingrese destino" class="form-control input-md">
    </div>
    <div class="col-md-1">
