<div class="box box-primary">
    <div class="box-header with-border">
        <h4 class="box-title">Lista de No Consumibles</h4>
    </div>
    <div class="box-body">
  ...
  <script>
    ...
    function guardarNoConsumible() {
       ...
       // formData = formToObject(formData);
        $.ajax({
            type: 'POST',
            dataType: 'JSON',
            url: 'general/NoConsumible/guardarNoConsumible',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function editarNoConsumible() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'JSON',
            url: 'general/NoConsumible/editarNoConsumible',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
...
/////////////////////////////////////////////////////
    ...
    function eliminarNoConsumible() {
        $.ajax({
            ...
            url: 'general/NoConsumible/eliminarNoConsumible/',
...
function trazabilidad(e) {
  ...
  function ListarTrazabilidadNoConsumible() {
        $.ajax({
            ...
            url: 'general/NoConsumible/ListarTrazabilidadNoConsumible/',
            success: function(data) {
                console.log('entra por aka');
            },
            error: function(result) {
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="mdl-titulo">Trazabilidad: Nombre No Consumibles - Codigo = ></h4>
                </div>
