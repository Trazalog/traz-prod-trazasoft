                    ...
                    <div class="box box-primary">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <!--_________________ TARGET 1_________________-->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!--_________________ BODY TARGET 1_________________-->

                                    <div class="box-body">
                                        <div style="margin-bottom:50px;">
                                            <?php
                                            Card::create(array(
                                                "dataStore" => $this->dataStore('data_etapa'),
                                                "value" => "etapa",
                                                // "format" => array(
                                                //     "value" => array(
                                                //         "prefix" => ""
                                ...
                                <!--_________________ TARGET 2_________________-->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!--_________________ BODY TARGET 2_________________-->

                                    <div class="box-body">
                                        <div style="margin-bottom:50px;">
                                            <?php
                                            Card::create(array(
                                                "dataStore" => $this->dataStore('data_responsable'),
                                                "value" => "responsable",
                                                // "format" => array(
                                                //     "value" => array(
                                                //         "prefix" => ""
                                ...
                                <!--_________________ TARGET 3_________________-->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!--_________________ BODY TARGET 3_________________-->

                                    <div class="box-body">
                                        <div style="margin-bottom:50px;">
                                            <?php
                                            Card::create(array(
                                                // "dataStore" => $this->dataStore('data_producto'),
                                                "value" =>$this->src("apiarray")->query("select sum(amount) from payments"),
                                                // "format" => array(
                                                //     "value" => array(
                                                //         "prefix" => ""
                                                //     )
