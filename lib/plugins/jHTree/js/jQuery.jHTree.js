...
(function ($) {
    ...
    $.widget("jHtree.jHTree", {
        ...
        _constructTree: function (jsonStructureObject) {
            ...
            $tree.addClass('treeplugin').append("<ul id='tremainul'>");
        ...
        _treeDrop: function () {
            var thisparent = this;
            $("li", ".treeplugin").droppable({

                greedy: true,
                accept: ".treeplugin ul > li",
        ...
        _interactionEvents: function () {
            ...
            $(".treeplugin").on('mouseleave', '.tnode', function () {
            ...
            $(".treeplugin").on("click", ".trcont > .ui-widget-header", function () {
                $(this).parent().parent().find('.trchl').slideToggle('slow', "easeOutBounce", function () {
                    // Animation complete.
                });
            });

            $(".treeplugin").on("click", "div[data-func]", function () {
                var objbtn = $(this);
                var objfocus = objbtn.parent().closest('li');
                var objother = objfocus.parent().find('> li');
                var targetobjs = $(objother).not(objfocus);
            ...
            $("#zmrslidr").slider({
                ...
                slide: function (event, ui) {
                    ...
                    if (brwstp == true) {
                        ...
                        $('.treeplugin').css('MozTransform', 'scale(' + ui.value + ')');
                    } else {

                        $('.treeplugin').css('zoom', ' ' + ui.value + '%');
                    }
                }
            });
