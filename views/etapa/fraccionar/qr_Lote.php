...
<div class='col-md-12 col-sm-12'>	
    <h5 id='cantidadLote'>Cantidad: <strong><?php echo $cantidad ?></strong></h5>
</div>
<div class='col-md-12 col-sm-12'>	
    <h5 id='fechaLote'>Fecha: <strong><?php echo $fecha ?></strong></h5>
</div>
<div class='col-md-12 col-sm-12'>	
    <h5 id='batchLote'>Batch: <strong><?php echo $batch ?></strong></h5>
</div>